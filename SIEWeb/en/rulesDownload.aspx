<%@ Page Title="" Language="C#" MasterPageFile="./indexMaster.master" AutoEventWireup="true" CodeFile="rulesDownload.aspx.cs" Inherits="newslist" %>
        ...
        <div class="containBanner">
            ...
            <div id="Div1" class="containLeft" runat="server">
                ...
                <ul class="navContain" id="navContain">
                    <li id="li_student" runat="server"><a href="rulesDownload.aspx?viewlevel=2">学院规章制度</a></li>
                    <li id="li_teacher" runat="server"><a href="rulesDownload.aspx?viewlevel=3">学生规章制度</a></li>
                </ul>
            </div>
