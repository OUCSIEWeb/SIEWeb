<%@ Page Title="" Language="C#" MasterPageFile="./indexMaster.master" AutoEventWireup="true" CodeFile="ZAlist.aspx.cs" Inherits="ZAlist" %>
        ...
        <div class="containBanner">
            ...
            <div id="Div1" class="containLeft" runat="server">
                ...
                <ul class="navContain" id="navContain">
                    <li runat="server" id="Li3"> <a href="ZAlist.aspx?classid=6">中美合作项目</a></li>
                    <li runat="server" id="student_li"><a href="ZAlist.aspx?classid=7">中澳合作项目</a></li> 
                </ul>
            </div>
