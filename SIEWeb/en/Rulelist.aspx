<%@ Page Title="" Language="C#" MasterPageFile="./indexMaster.master" AutoEventWireup="true" CodeFile="Rulelist.aspx.cs" Inherits="Rulelist" %>
        ...
        <div class="containBanner">
            ...
            <div id="Div1" class="containLeft" runat="server">
                ...
                <ul class="navContain" id="navContain">
                    <li runat="server" id="Li3"> <a href="Rulelist.aspx?classid=8">学院规章制度</a></li>
                    <li runat="server" id="student_li"><a href="Rulelist.aspx?classid=9">学生规章制度</a></li> 
                </ul>
            </div>
