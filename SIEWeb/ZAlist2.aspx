<%@ Page Title="" Language="C#" MasterPageFile="~/indexMaster.master" AutoEventWireup="true" CodeFile="ZAlist2.aspx.cs" Inherits="ZAlist2" %>
        ...
        <div class="containBanner">
            ...
            <div id="Div1" class="containLeft" runat="server">
                ...
                <ul class="navContain" id="navContain">
                    ...
                    <li runat="server" id="Li3"> <a href="ZAlist2.aspx?classid=10">招生简章</a></li>
