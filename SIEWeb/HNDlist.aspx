<%@ Page Title="" Language="C#" MasterPageFile="~/indexMaster.master" AutoEventWireup="true" CodeFile="HNDlist.aspx.cs" Inherits="HNDlist" %>
        ...
        <div class="containBanner">
            ...
            <div id="Div1" class="containLeft" runat="server">
                ...
                <ul class="navContain" id="navContain">
                    <li runat="server" id="Li3"> <a href="HNDlist.aspx?classid=3">招生简章</a></li>
                    <li> <a   runat="server" id="notice_li" href="HNDlist.aspx?classid=4">教学教务</a></li>
                    <li runat="server" id="student_li"><a href="HNDlist.aspx?classid=5">学子风采</a></li> 
                    <li runat="server" id="Li1"><a href="pageShow.aspx?pid=103">合作院校</a></li> 
                    <li runat="server" id="Li2"><a href="filesDownload.aspx?viewlevel=4">报名表下载</a></li> 
                </ul>
            </div>
